...
import { resetEdit, setCurrentIDCollectionSelect, setEditMode, setIndexPlaying, setInfoMusicPlaying, setShuffle, showMusicControl, showTabbar } from '@services/redux/actions';
